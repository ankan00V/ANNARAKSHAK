...
Only farms are seeded, all flagged is_demo. Diagnoses, cases, confirmations
and alerts come from running the real flows — nothing on the officials'
dashboard is invented. Farms are clustered a few km apart so a confirmed case
has neighbours inside the spread radius.
"""
...
def main() -> None:
    ...
    with SessionLocal() as db:
        ...
        db.commit()
        print(f"seeded {len(FARMS)} demo farms into {DB_URL}")
