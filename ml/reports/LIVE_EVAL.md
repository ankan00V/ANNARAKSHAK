...
Generated 2026-09-15 15:53 by `ml/live_eval.py` with model `icar+extra-efficientnet_v2_s-warmstart-20260915`, through the real API (confidence gate, Doubt Doctor, live walk). Held-out images only: the ICAR test split (same as the model report) and up to 20 held-out images per class from the extra sources.

## 1. Photo diagnosis

| Images | Advised | Right when advised | Asked a question | Sent to expert | Asked for a retake |
|---|---|---|---|---|---|
| 469 | 395 (84%) | **97.5%** | 12 | 34 | 28 |

- ICAR field photos: 126 images, advised 114, right when advised 96.5%
...
| maize_maydis_leaf_blight | 18 | found | maize_maydis_leaf_blight | maize_turcicum_leaf_blight | right |
...
| rice_brown_spot | 20 | found | rice_brown_spot | rice_blast | right |
| rice_false_smut | 23 | found | rice_false_smut | — | right |
| rice_healthy | 20 | check | — | rice_blast | right |
| rice_leaf_blast | 17 | found | rice_blast | — | right |
| rice_leaf_folder | 20 | found | rice_leaf_folder | rice_blast, rice_skipper | right |
...
| rice_yellow_stem_borer | 20 | found | rice_yellow_stem_borer | rice_blast | right |
